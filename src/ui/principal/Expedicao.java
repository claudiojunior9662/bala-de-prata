 ...
 * @author claud
 */
public class Expedicao extends javax.swing.JFrame {

    /**
     * Creates new form ExpedicaoNovo2
     */
    public Expedicao() {
        initComponents();
        ...
        new Thread("Atualizacaoes expedicao") {
            @Override
            public void run() {
                while (true) {
                    try {
                        try {
                            ...
                            taAvisos.setText("* Produtos abaixo do estoque:\n\n"
                                    + avProd.toString()
                                    + "\n\n* Dicas de utilização:\n\n"
    ...
    private void initComponents() {
        ...
        menuNotaVenda = new javax.swing.JMenuItem();
        menuRelatorios = new javax.swing.JMenu();
        relatoriosOrdemProducao = new javax.swing.JMenuItem();
        relFat = new javax.swing.JMenuItem();
        ...
        menuNotaVenda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/faturamento.png"))); // NOI18N
        menuNotaVenda.setText("FATURAMENTO");
        menuNotaVenda.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                menuNotaVendaMousePressed(evt);
            }
        });
        menuNotaVenda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuNotaVendaActionPerformed(evt);
            }
        });
        menuPrincipal.add(menuNotaVenda);
        ...
        relFat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/faturamento.png"))); // NOI18N
        relFat.setText("FATURAMENTOS");
        relFat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                relFatActionPerformed(evt);
            }
        });
        menuRelatorios.add(relFat);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(atualizacao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void menuNotaVendaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuNotaVendaMousePressed

    }//GEN-LAST:event_menuNotaVendaMousePressed

    private void menuNotaVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuNotaVendaActionPerformed
        Controle.getDefaultGj().abrirJanelas(FatFrame.getInstancia(loading,Controle.getDefaultGj()), "FATURAMENTO");
    }//GEN-LAST:event_menuNotaVendaActionPerformed
    ...
    private void relFatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_relFatActionPerformed
        Controle.getDefaultGj().abrirJanelas(RelatorioFat.getInstancia(loading), "RELATÓRIOS - FATURAMENTOS");
    }//GEN-LAST:event_relFatActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Expedicao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JMenuItem menuNotaVenda;
    private javax.swing.JMenu menuPrincipal;
    private javax.swing.JMenu menuRelatorios;
    private javax.swing.JMenu menuSair;
    private javax.swing.JMenuItem relFat;
